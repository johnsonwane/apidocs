...
$stmt = $pdo->prepare('INSERT INTO api_items(category_id, name, method, path, description, request_params, response_fields, request_example, response_example, test_url) VALUES(:category_id, :name, :method, :path, :description, :request_params, :response_fields, :request_example, :response_example, :test_url)');
$stmt->execute([
